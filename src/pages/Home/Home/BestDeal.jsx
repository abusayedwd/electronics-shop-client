      ...
      <div className="tab md:flex justify-between">
         ...
         <div className='grid md:grid-cols-3 gap-4 mt-6'> 
                {
                        ...
                        <div className='flex items-center justify-evenly  p-3 border-r-2' key={feature.id}
                         
                        >
                                <div>
                                <img className='h-28 cade w-28' src={feature.image} alt="" />
                                </div>
                                <div>
        ...
        {activeTab === 1 && 
         <div className='grid md:grid-cols-3 gap-4 mt-6'> 
         {
                 ...
                 <div className='flex items-center justify-evenly  p-3 border-r-2' key={hotsel.id}
                  
                 >
                         <div>
                         <img className='h-28 cade w-28' src={hotsel.image} alt="" />
                         </div>
                         <div>
        ...
        {activeTab === 2 && 
         <div className='grid md:grid-cols-3 gap-4 mt-6'> 
         {
                 ...
                 <div className='flex items-center justify-evenly  p-3 border-r-2' key={tread.id}
                  
                 >
                         <div>
                         <img className='h-28 cade w-28' src={tread.image} alt="" />
                         </div>
                         <div>
